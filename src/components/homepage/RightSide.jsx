...
const RightSide = ({ className }) => {
    return (
        <aside className={`${className}`}>
            ...
            <button className='flex items-center gap-3 text-[18px] border border-blue-500 text-blue-500 px-4 py-1 rounded-lg cursor-pointer mt-3 hover:bg-blue-500 hover:text-white'><FcGoogle /> Login with Google</button>
            <button className='flex items-center gap-3 text-[18px] border border-blue-500 text-blue-500 px-4 py-1 rounded-lg cursor-pointer mt-3 hover:bg-blue-500 hover:text-white'><FaGithub /> Login with Github</button>
